...
-   [Nested while loops](https://intranet.hbtn.io/rltoken/lnzT56HYlUClB0-yDfwiqw "Nested while loops")
-   [C - Functions](https://intranet.hbtn.io/rltoken/mWFYXPYiI87lYf6tyYtD_Q "C - Functions")
-   [Learning to Program in C (Part 06)](https://intranet.hbtn.io/rltoken/xpQGxUCqMewY3qcbTU3NTw "Learning to Program in C (Part 06)") (_stop at 14:00_)
-   [What is the purpose of a function prototype?](https://intranet.hbtn.io/rltoken/7P08UbWvbOnyohRhLjSKGw "What is the purpose of a function prototype?")
-   [C - Header Files](https://intranet.hbtn.io/rltoken/gnZvo3oRJ5CR_LsKz8tzVA "C - Header Files") (_stop before the “Once-Only Headers” paragraph_)
